...
function fromJSON(proto, json) {
	return Object.setPrototypeOf(JSON.parse(json), proto);//Object.setPrototypeOf(obj, prototype);-obj-объект, которому устанавливается пртотип, prototype-новый прототип объекта
                                                         //obj.__proto__ = proto
}
...
let cssSelectorBuilder = {//просмотреть
